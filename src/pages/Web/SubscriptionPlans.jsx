  ...
  const faq = [
    {
      ...
      answer:
        "除了享受 24bit / 192kHz Hi-Res無損音質，你也能隨時隨地使用 PULSE App，自訂歌單、AI智能推薦、個人電台等功能應有盡有。我們也提供網頁版免費試用，快來體驗看看吧～",
    },
    {
      id: "Q2",
      question: "多人方案有任何限制嗎？",
      answer:
        "沒有。無論是相距千里的家人或朋友，PULSE都歡迎你們一起享受音樂，無需受距離及 IP 的限制！",
    },
    {
      id: "Q3",
    ...
    <>
      ...
      >
        <div className="banner-title container d-flex flex-column align-items-center">
          ...
          >
            <h2 className="mb-0 ps-lg-3 ps-2 pe-lg-5 pe-3">探索方案</h2>
          ...
          <div className="row pt-lg-8 pt-0">
            ...
            <div className="col-md-6 col-lg-3">
              <div className="feature-card d-flex flex-column align-items-center">
                ...
                <div className="pt-0 pt-lg-5 feature-text d-flex flex-column align-items-center">
                  <h5 className="pt-lg-2 pt-0">共享脈動帳號</h5>
                  <p className="mb-0">無需同住一個屋簷下，</p>
                  <p className="mb-0">PULSE讓你與好友零距離。</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
              <div className="feature-card d-flex flex-column align-items-center">
                ...
                <div className="pt-0 pt-lg-5 feature-text d-flex flex-column align-items-center">
                  ...
                  <p className="mb-0">上班偷聽用網頁播放器，</p>
                  <p className="mb-0">健身通勤用PULSE App！</p>
                </div>
              </div>
            </div>
            <div className="col-md-6 col-lg-3">
              <div className="feature-card d-flex flex-column align-items-center">
                ...
                <div className="pt-0 pt-lg-5 feature-text d-flex flex-column align-items-center">
                  ...
                  <p className="mb-0">立即創建專屬你的直播電台</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            >
              ...
              <div className="plan-discription position-absolute">
                ...
                <h1>學生方案</h1>
                <h5 className="fs-lg-5 fs-6">*須符合資格方可享學生優惠</h5>
              </div>
            </div>
            <div className="col-lg-6">
              <div className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5">
                <div className="discription">
                  ...
                  <h1 className="fw-bold blur-font">1人方案</h1>
                </div>
                ...
                <div className="discription">
                  <div className="plan-card-header d-flex py-3">
                    <img
                      ...
                      alt=""
                    />
                    <h6 className="mb-0">PARTY FOR FRIENDS</h6>
                  </div>
                  <h1 className="fw-bold blur-font">4人方案</h1>
                </div>
                <div className="price d-flex align-items-center">
              ...
              <div className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5">
                <div className="discription">
                  ...
                  <h1 className="fw-bold blur-font">10人方案</h1>
                </div>
                <div className="price d-flex align-items-center">
                ...
                <div className="discription">
                  <div className="plan-card-header d-flex py-3">
                    <img
                      ...
                      alt=""
                    />
                    <h6 className="mb-0">PREMIUM FOR FRIENDS & FAMILY</h6>
                  </div>
                  <h1 className="fw-bold blur-font">4人方案</h1>
                </div>
                <div className="price d-flex align-items-center">
                ...
                <div className="discription">
                  <div className="plan-card-header d-flex py-3">
                    <img
                      ...
                      alt=""
                    />
                    <h6 className="mb-0">PREMIUM FOR EVERYONE</h6>
                  </div>
                  <h1 className="fw-bold blur-font">10人方案</h1>
                </div>
                <div className="price d-flex align-items-center">
                ...
                <div className="QA-group" key={item.id}>
                  ...
                  >
                    <div className="d-flex align-items-center">
                      ...
                      <h4 className="ps-6">{item.question}</h4>
                    </div>
                  ...
                  <div className="collapse" id={item.id}>
                    <div className="d-flex flex-row align-items-center pb-4">
                      ...
                      <p className="ps-6 mb-0">{item.answer}</p>
                    </div>
                  </div>
                </div>
              );
