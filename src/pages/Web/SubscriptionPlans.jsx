			...
			<div className="content container">
				...
				<section className="plan-block py-9 py-lg-10">
					<div className="row">
						...
						<div className="col-lg-6">
							<Link className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5 text-decoration-none" to="/payment?plan=1">
							...
							<Link className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5 text-decoration-none" to="/payment?plan=2">
								<div className="discription">
									<div className="plan-card-header d-flex py-3">
										<img
											className="me-2"
							...
							<Link className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5 text-decoration-none" to="/payment?plan=3">
								<div className="discription">
									<div className="plan-card-header d-flex py-3">
										<img
											className="me-2"
				...
				<section className="plan-block py-9 py-lg-10">
					<div className="row">
						...
						<div className="col-lg-6">
							<Link className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5 text-decoration-none" to="/payment?plan=4">
								<div className="discription">
									<div className="plan-card-header d-flex py-3">
										<img
											className="me-2"
							...
							<Link className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5 text-decoration-none" to="/payment?plan=5">
								<div className="discription">
									<div className="plan-card-header d-flex py-3">
										<img
											className="me-2"
							...
							<Link className="plan-card rounded-4 d-flex justify-content-between align-items-center px-6 py-5 mb-5 text-decoration-none" to="/payment?plan=6">
								<div className="discription">
									<div className="plan-card-header d-flex py-3">
										<img
											className="me-2"
