		...
		<>
			<div className="col-lg-9 col-12 player-scrollbar">
				<div className="p-5 border-transparent rounded-4 player-bg mb-5">
					...
					<h2 className="h2 mb-5">Porter Robinson 的搜尋結果</h2>
					<div className="row mb-5">
						<div className="col-lg-4 col-12">
							...
							<a className="p-5 player-bg rounded-4 mb-5 mb-lg-0 d-block text-decoration-none">
								<img
									...
									width={120}
								/>
								<h3 className="h3 mb-1">Porter Robinson</h3>
						...
						<div className="col-lg-8 col-12">
							...
							<PlayerCardSong
								cardTitle={"Shelter"}
								cardContent={"Porter Robinson"}
								cardImage={PlayerImages["card-pic-3_1"]}
							/>
							<div className="card-song p-1 d-flex align-items-center rounded-4">
								...
								<div className="d-flex flex-column align-items-start">
									...
									<p className="fs-7 mb-0">Porter Robinson</p>
								</div>
							</div>
						</div>
					</div>
							...
							<div className="row">
								...
								<div className="col-6 col-lg-3">
									<div className="card-album p-2 rounded-4">
										<img
											src={PlayerImages["card-pic-3_3"]}
											alt=""
											className="w-100 mb-3 rounded-4"
										/>
										<h6 className="h6 mb-1">Smile! :D</h6>
