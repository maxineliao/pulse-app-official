        ...
        >
          <div className="position-absolute top-0 start-0 z-1 d-flex align-items-center justify-content-between w-100 py-5">
            ...
            <div className="d-flex gap-2">
              {swiper2 !== null && (
                <>
                  <SwiperButtonPrev swiperIndex={2} swiper={swiper2}>
                    <ChevronLeft />
                  </SwiperButtonPrev>
                  <SwiperButtonNext swiperIndex={2} swiper={swiper2}>
                    <ChevronRight />
                  </SwiperButtonNext>
                </>
              )}
        ...
        >
          ...
          <div className="position-absolute top-0 start-0 z-1 d-flex align-items-center justify-content-between w-100 py-5">
            ...
            <div className="d-flex gap-2">
              {swiper3 !== null && (
                <>
                  <SwiperButtonPrev swiperIndex={2} swiper={swiper3}>
                    <ChevronLeft />
                  </SwiperButtonPrev>
                  <SwiperButtonNext swiperIndex={2} swiper={swiper3}>
                    <ChevronRight />
                  </SwiperButtonNext>
                </>
              )}
