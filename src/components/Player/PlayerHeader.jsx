...
export default function PlayerHeader() {
	...
	const username = useSelector((state)=>state.auth.memberName);
	...
	return (
		<header className="container-fluid fixed-top">
			<div className="navbar navbar-player navbar-dark navbar-expand-lg rounded-4 justify-content-between pe-3">
				...
				<NavLink
					to="/member_center"
					className="nav-btn btn btn-outline-primary rounded-3 me-2 pe-lg-2 order-lg-3 d-none d-lg-flex align-items-center"
				>
					<img
						className="rounded-circle object-fit-cover me-1"
						src={PlayerImages.memberDefaultImg}
						alt="Benson"
						width="24"
						height="24"
					/>
